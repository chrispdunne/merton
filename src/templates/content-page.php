...
<article id="post-<?php the_ID(); ?>">
	...
	<?php if ( get_field( 'wp_content_first' ) && !is_front_page()  ) { 
		?><div class="max-w-7xl my-12 mx-auto px-12"><?php the_content() ?></div><?php 
	} ?>
	<?php get_template_part( 'src/templates/page/acf-content' ); ?>
	<?php if (!get_field( 'wp_content_first' ) && !is_front_page() ) : 
		?><div class="max-w-7xl my-12 mx-auto px-12"><?php 
	the_content() ?></div><?php endif; ?>
